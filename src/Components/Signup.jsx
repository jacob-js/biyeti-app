        ...
        >
            {({ handleSubmit, errors, handleChange, touched }) =>(
                <>
                    ...
                    <CommonInput required error={touched.firstname && errors.firstname} label="Nom" onChangeText={handleChange('firstname')} 
                    ...
                    <CommonInput required maxLength={4} error={touched.password && errors.password} onChangeText={handleChange('password')} placeholder='Mot de passe' 
                    ...
                    <View style={{
                        ...
                        <Button isLoading={false} isLoadingText={<Text style={{ color: 'white' }}>Patientez...</Text>} style={styles.loginBtn} _text={{ fontWeight: 'bold', textTransform: 'uppercase' }} onPress={() =>handleSubmit()}>M'inscrire</Button>
                    </View>
                    <View>
